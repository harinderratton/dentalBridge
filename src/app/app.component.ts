...
export class MyApp {
  ...
  constructor( private funtions : Functions, private admobFree: AdMobFree,  private fb: Facebook, public events:EventsService, public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen, public alertCtrl: AlertController, public values: Values, public translateService: TranslateService) {
  ...
  menuOptions(){
    ...
    if(this.userType == 'manager'){
      this.pages = [ 
        ...
        { title: 'My Profile', component: ViewProfilePage ,icon: 'person'},
        { title: 'Support', component: SupportPage ,icon: 'information'},
         ]; 
