...
//   }
  ...
  addToAppliedJob(employee_id,job_id,post_id,jobDetails, profile:any, resume:any){
	var uid = firebase.auth().currentUser.uid;
...
//   }
  ...
  addToWorker(employee_id:any,job_id:any,post_id:any,jobDetails:any, profile:any, resume:any){
	var uid = firebase.auth().currentUser.uid;
...
//   }
  ...
  addToEmployee(employee_id,job_id,user_id,post_id,jobDetails, profile, resume){
