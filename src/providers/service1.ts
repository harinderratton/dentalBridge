...
export class Service1 {
  ...
  ,phone:String,poster:String,minsalary:String,maxsalary:String,description:String,category:String,localdate:any,company,email,is_recruiter,company_size,experience,qualification,lat='',lng=''){
