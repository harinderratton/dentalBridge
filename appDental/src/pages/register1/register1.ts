...
export class Register1Page {
  ...
  constructor(private iab: InAppBrowser, public nav: NavController, public navParams: NavParams, public functions: Functions, public auth: Auth1, public loadingCtrl: LoadingController/*, private twitter: TwitterConnect*/,
     private fb: Facebook,
